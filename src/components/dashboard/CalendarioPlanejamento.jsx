...
import { ChevronLeft, ChevronRight, Calendar, Filter, Trash2, CalendarDays, RefreshCw, Users, ListOrdered, User, LineChart } from "lucide-react";
...
// --- Sub-componente de grupo diário de atividades ---
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1.5 mb-1.5">
              {disciplineColors.map(d => (
                <div key={d.name} className="w-2.5 h-2.5 rounded-full" style={{ backgroundColor: d.color }} title={d.name} />
              ))}
              <Button
                variant="ghost"
                size="icon"
