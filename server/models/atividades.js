...
const ALLOWED_UPDATE_FIELDS = new Set([
  ...
  'descricao', 'status', 'inicio_previsto', 'fim_previsto', 'empreendimento_id',
  'equipe_id', 'disciplina_id', 'responsavel_id'
]);
...
async function createAtividade(data) {
  ...
  const res = await pool.query(
    ...
    [
      titulo || null, etapa || null, predecessora || null, funcao || null,
      subdisciplina || null, (tempo == null ? null : Number(tempo)), id_atividade || null,
      descricao || null, status || null, inicio_previsto || null, fim_previsto || null,
      empreendimento_id || null, equipe_id || null, disciplina_id || null, responsavel_id || null
    ]
  );
  return res.rows[0];
}
